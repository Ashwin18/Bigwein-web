...
@section('script')
    <script>
        ...
        function projectReviewQueueFormatter(value, row) {
            ...
            return '<article class="bw-queue-card bw-queue-card--project"><div class="bw-queue-left"><div class="bw-queue-main"><div class="bw-queue-icon"><i class="bi bi-buildings"></i></div><div class="bw-queue-title"><strong>'+projectQueueEscape(row.title)+'</strong><span>'+projectQueueEscape(row.owner_name || 'Owner unavailable')+'</span></div></div><div class="bw-queue-inline-meta"><span><i class="bi bi-tag"></i>'+projectQueueEscape(category)+'</span></div></div><div class="bw-queue-middle"><div class="bw-queue-value"><small>Contact</small><strong>'+projectQueueEscape(contact)+'</strong></div><div class="bw-queue-value"><small>Submitted</small><strong>'+projectQueueEscape(submitted)+'</strong></div></div><div class="bw-queue-right"><div class="bw-queue-statuses"><span class="bw-review-status bw-review-status--'+projectQueueEscape(approval)+'"><span class="bw-review-status__dot"></span>'+projectQueueEscape(approval.replace(/_/g,' ').replace(/\b\w/g,function(c){return c.toUpperCase();}))+'</span><span class="bw-review-status bw-review-status--'+(active?'active':'inactive')+'"><span class="bw-review-status__dot"></span>'+(active?'Active':'Inactive')+'</span></div><div class="bw-queue-actions">'+primary+(secondary?'<div class="bw-queue-secondary-actions">'+secondary+'</div>':'')+'</div></div></article>';
        }
