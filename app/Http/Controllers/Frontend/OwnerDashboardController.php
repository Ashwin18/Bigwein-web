...
class OwnerDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.owner.dashboard', compact(
            ...
            'recentEnquiries', 'recentListings', 'activePlan', 'weeklyViews', 'activePlanName'
        ));
    }
